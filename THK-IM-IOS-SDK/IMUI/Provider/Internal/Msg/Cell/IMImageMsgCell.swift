...
//        }
    ...
    func downloadShrinkImage(_ imageBody: IMImageMsgBody, _ msg: Message) {
...
//        let path = storageModule.allocSessionFilePath(msg.sessionId, msg.fromUId, filePaths.1, "img")
//        self.unregister()
