...
class IMEmojiPanelView: UIView, UICollectionViewDelegate, UICollectionViewDataSource,
    UICollectionViewDelegateFlowLayout
{
    ...
    private var emojiPanels = [IMBasePanelViewProvider]()
    ...
    lazy var emojiTabView: UICollectionView = {
        ...
        collectionView.register(
            IMEmojiPanelTitleCell.self, forCellWithReuseIdentifier: self.cellTitleId)
    ...
    lazy var emojiContentView: UICollectionView = {
        ...
        collectionView.backgroundColor = UIColor.clear
        collectionView.register(
            IMEmojiPanelContentCell.self, forCellWithReuseIdentifier: self.cellContentId)
        collectionView.alpha = 1
        return collectionView
    }()
    ...
    override func layoutSubviews() {
        ...
        if selectIndex.row < emojiPanels.count {
            self.emojiTabView.selectItem(
                at: selectIndex, animated: false, scrollPosition: .centeredHorizontally)
        }
    }
        ...
        -> UICollectionViewCell
    {
        if collectionView == self.emojiTabView {
            let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: self.cellTitleId, for: indexPath)
            ...
            let cell = collectionView.dequeueReusableCell(
                withReuseIdentifier: self.cellContentId, for: indexPath)
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        if collectionView == self.emojiTabView {
            self.emojiContentView.scrollToItem(
