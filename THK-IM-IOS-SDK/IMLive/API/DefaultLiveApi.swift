...
class DefaultLiveApi: LiveApi {
    ...
    func createRoom(_ req: CreateRoomReqBean) -> Observable<CreateRoomResBean> {
        return roomApi.rx
            ...
            .asObservable()
            .compose(RxTransformer.shared.response2Bean(CreateRoomResBean.self))
    }
    ...
    func joinRoom(_ req: JoinRoomReqBean) -> Observable<JoinRoomResBean> {
        return roomApi.rx
            ...
            .asObservable()
            .compose(RxTransformer.shared.response2Bean(JoinRoomResBean.self))
    }
    ...
    func publishStream(_ req: PublishReqBean) -> Observable<PublishResBean> {
        return streamApi.rx
            ...
            .asObservable()
            .compose(RxTransformer.shared.response2Bean(PublishResBean.self))
    }
    ...
    func playStream(_ req: PlayReqBean) -> Observable<PlayResBean> {
        return streamApi.rx
            ...
            .asObservable()
            .compose(RxTransformer.shared.response2Bean(PlayResBean.self))
    }
}
