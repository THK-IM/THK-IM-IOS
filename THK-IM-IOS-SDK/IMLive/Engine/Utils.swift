...
extension DispatchTimeInterval: @retroactive CustomDebugStringConvertible {
...
extension AVAudioSession {
    ...
    var describedState: String {
        var description =
            "AudioSession: category=\(self.category.rawValue)" + ", mode=\(self.mode.rawValue)"
        ...
        if #available(iOS 14.5, *) {
            description +=
                ", prefersNoInterruptionsFromSystemAlerts=\(self.prefersNoInterruptionsFromSystemAlerts)"
        }
        description +=
