...
public protocol MessageModule: BaseModule {
     ...
     * 分页获取本地session
     */
    func queryLocalSessions(_ parentId: Int64, _ count: Int, _ mTime: Int64) -> Observable<
        [Session]
    >
     ...
     */
    func sendMessage(
        _ sessionId: Int64, _ type: Int, _ body: Codable?, _ data: Codable?, _ atUser: String?,
     ...
     * 批量删除多条消息
     */
    func deleteMessages(_ sessionId: Int64, _ messages: [Message], _ deleteServer: Bool)
        -> Observable<Void>
