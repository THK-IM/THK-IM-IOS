...
public protocol SessionDao {
     ...
     * @param mTime 修改时间
     */
    func findByParentId(_ parentId: Int64, _ count: Int, _ mTime: Int64) throws -> [Session]?

    /**
     * 根据类型查询所有session
     */
    func findAll(_ type: Int) throws -> [Session]?

    /**
     * 查询所有未读session
     */
    func findUnreadSessions(_ parentInd: Int64) throws -> [Session]?
