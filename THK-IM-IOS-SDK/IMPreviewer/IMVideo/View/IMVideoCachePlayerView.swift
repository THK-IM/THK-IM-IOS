...
public class IMCacheVideoPlayerView: UIView, AVAssetResourceLoaderDelegate {
    ...
    private lazy var playButton: UIButton = {
        ...
        b.setImage(ResourceUtils.loadImage(named: "icon_video_play"), for: UIControl.State.normal)
        b.setImage(ResourceUtils.loadImage(named: "icon_video_pause"), for: UIControl.State.selected)
        b.addTarget(
            self,
